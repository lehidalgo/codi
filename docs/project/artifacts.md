...
| Category                | Skills                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| ----------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Brand Identity**      | codi-dev-brand-creator, codi-codi-brand                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| **Code Quality**        | codi-architecture-review, codi-code-review, codi-dev-e2e-testing, codi-dev-gate-deep-modules, codi-guided-qa-testing, codi-pr-review, codi-project-quality-guard, codi-receiving-code-review, codi-refactoring, codi-security-scan, codi-dev-session-recovery, codi-webapp-testing                                                                                                                                                                                                                                             |
...
| **Developer Workflow**  | codi-audit-fix, codi-dev-brain-ui, codi-brainstorming, codi-branch-finish, codi-bug-fix-workflow, codi-caveman, codi-debugging, codi-diagnose, codi-feature-workflow, codi-guided-execution, codi-dev-init-knowledge-base, codi-migration-workflow, codi-plan-execution, codi-project-workflow, codi-refactor-workflow, codi-dev-sheets-sync, codi-dev-step-documenter, codi-subagent-orchestration, codi-tdd, codi-dev-team-charter, codi-dev-team-consolidation-workflow, codi-dev-using-codi, codi-worktrees, codi-zoom-out |
| **Planning**            | codi-discover, codi-dev-gate-plan-coverage, codi-plan-writing, codi-roadmap                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
