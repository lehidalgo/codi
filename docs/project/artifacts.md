...
| Category                | Skills                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| ----------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Brand Identity**      | codi-codi-brand, codi-dev-brand-creator                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| **Code Quality**        | codi-architecture-review, codi-code-review, codi-dev-e2e-testing, codi-dev-gate-deep-modules, codi-dev-session-recovery, codi-guided-qa-testing, codi-pr-review, codi-project-quality-guard, codi-receiving-code-review, codi-refactoring, codi-security-scan, codi-webapp-testing                                                                                                                                                                                                                                             |
| **Codi Platform**       | codi-dev-agent-creator, codi-dev-artifact-contributor, codi-dev-compare-preset, codi-dev-docs-manager, codi-dev-operations, codi-dev-preset-creator, codi-dev-refine-rules, codi-dev-rule-creator, codi-dev-rule-feedback, codi-dev-skill-creator                                                                                                                                                                                                                                                                              |
| **Content Creation**    | codi-content-factory                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| **Content Refinement**  | codi-humanizer                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| **Creative and Design** | codi-claude-artifacts-builder, codi-frontend-design                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| **Developer Tools**     | codi-claude-api, codi-codebase-explore, codi-codebase-onboarding, codi-commit, codi-dev-graph-sync, codi-html-live-inspect, codi-mcp-ops, codi-mobile-development, codi-project-documentation                                                                                                                                                                                                                                                                                                                                  |
| **Developer Workflow**  | codi-audit-fix, codi-brainstorming, codi-branch-finish, codi-bug-fix-workflow, codi-caveman, codi-debugging, codi-dev-brain-ui, codi-dev-init-knowledge-base, codi-dev-sheets-sync, codi-dev-step-documenter, codi-dev-team-charter, codi-dev-team-consolidation-workflow, codi-dev-using-codi, codi-diagnose, codi-feature-workflow, codi-guided-execution, codi-migration-workflow, codi-plan-execution, codi-project-workflow, codi-refactor-workflow, codi-subagent-orchestration, codi-tdd, codi-worktrees, codi-zoom-out |
| **Planning**            | codi-dev-gate-plan-coverage, codi-discover, codi-plan-writing, codi-roadmap                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| **Productivity**        | codi-audio-transcriber                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| **Testing**             | codi-quality-gates, codi-test-suite, codi-verify-evidence                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
