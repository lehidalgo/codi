...
| **Developer Workflow**  | codi-audit-fix, codi-brain-ui, codi-brainstorming, codi-branch-finish, codi-bug-fix-workflow, codi-caveman, codi-debugging, codi-diagnose, codi-dispatching-parallel-agents, codi-evidence-gathering, codi-feature-workflow, codi-guided-execution, codi-init-knowledge-base, codi-migration-workflow, codi-plan-execution, codi-plan-writer, codi-project-workflow, codi-refactor-workflow, codi-sheets-sync, codi-step-documenter, codi-subagent-orchestration, codi-tdd, codi-team-charter, codi-verification, codi-worktrees, codi-zoom-out |
