...
| Bloque                           | Count | Skills                                                                                                                                                                |
| -------------------------------- | ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| A — Foundation                   | 4     | codi-team-charter, codi-caveman, codi-recall, codi-remember                                                                                                           |
...
| F — Workflow utility             | 4     | codi-worktrees, codi-dispatching-parallel-agents, codi-session-recovery, codi-session-log                                                                             |
...
| J — v3 brain features            | 3     | codi-brain-ui, codi-brain-consolidate, codi-brain-export/import                                                                                                       |
| K — Self-improvement             | 3     | codi-rule-feedback, codi-refine-rules, codi-compare-preset                                                                                                            |
| L — Metaskills artifact creators | 8     | codi-skill-creator, codi-rule-creator, codi-agent-creator, codi-preset-creator, codi-workflow-creator, codi-gate-creator, codi-skill-audit, codi-artifact-contributor |
...
- **Defer a marketplace v3.1** (contenido especializado): codi-canvas-design, codi-theme-factory, codi-html-live-inspect, codi-slack-gif-creator, codi-algorithmic-art, codi-pdf, codi-pptx, codi-xlsx, codi-docx, codi-content-factory, codi-audio-transcriber, codi-notebooklm, codi-mobile-development, codi-internal-comms, codi-codi-brand, codi-brand-creator, codi-claude-api, codi-claude-artifacts-builder, codi-mcp-ops, codi-box-validator, codi-step-documenter, codi-frontend-design, codi-humanizer, codi-roadmap, codi-graph-sync, codi-project-documentation, codi-project-quality-guard, codi-webapp-testing, codi-guided-execution, codi-guided-qa-testing.
...
- codi-init-knowledge-base (parcialmente cubierta por install + brain).
...
- **Subagents reducidos a 4**: pierden 18 specialized agents de Codi v2. Mitigación: dev puede crear custom subagent definitions con `codi-agent-creator` (skill bloque L).
...
4. Crear 3 NEW skills v3 (codi-clarify, codi-spec-writer, codi-prototype) + 3 brain features (codi-brain-ui, codi-brain-consolidate, codi-brain-export-import) + 1 capture rule (codi-capture-everything) + 2 workflow creators (codi-workflow-creator, codi-gate-creator).
