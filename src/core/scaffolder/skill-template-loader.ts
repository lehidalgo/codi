...
const STATIC_DIR_MAP: Record<string, string | null> = {
  ...
  [prefixedName("daily-log")]: skillTemplates.dailyLogStaticDir,
  ...
  [prefixedName("diagnostics")]: skillTemplates.diagnosticsStaticDir,
  ...
  [prefixedName("skill-feedback-reporter")]: skillTemplates.skillFeedbackReporterStaticDir,
  [prefixedName("step-documenter")]: skillTemplates.stepDocumenterStaticDir,
  [prefixedName("test-run")]: skillTemplates.testRunStaticDir,
