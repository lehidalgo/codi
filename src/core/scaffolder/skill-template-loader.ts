...
const TEMPLATE_MAP: Record<string, TemplateEntry> = {
  ...
  [prefixedName("using-codi")]: skillTemplates.usingCodi,
  ...
  [prefixedName("gate-deep-modules")]: skillTemplates.gateDeepModules,
  [prefixedName("gate-plan-coverage")]: skillTemplates.gatePlanCoverage,
  [prefixedName("init-knowledge-base")]: skillTemplates.initKnowledgeBase,
  ...
  [prefixedName("sheets-sync")]: skillTemplates.sheetsSync,
  [prefixedName("subagent-orchestration")]: skillTemplates.subagentOrchestration,
  [prefixedName("team-consolidation-workflow")]: skillTemplates.teamConsolidationWorkflow,
...
const STATIC_DIR_MAP: Record<string, string | null> = {
  ...
  [prefixedName("using-codi")]: skillTemplates.usingCodiStaticDir,
  ...
  [prefixedName("gate-deep-modules")]: skillTemplates.gateDeepModulesStaticDir,
  [prefixedName("gate-plan-coverage")]: skillTemplates.gatePlanCoverageStaticDir,
  [prefixedName("init-knowledge-base")]: skillTemplates.initKnowledgeBaseStaticDir,
  ...
  [prefixedName("sheets-sync")]: skillTemplates.sheetsSyncStaticDir,
  [prefixedName("subagent-orchestration")]: skillTemplates.subagentOrchestrationStaticDir,
  [prefixedName("team-consolidation-workflow")]: skillTemplates.teamConsolidationWorkflowStaticDir,
