...
export const preset: BuiltinPresetDefinition = {
  ...
  rules: [
    'typescript', 'code-style', 'testing', 'architecture', 'git-workflow',
    'error-handling', 'performance', 'security', 'documentation',
    'production-mindset', 'simplicity-first',
  ],
  skills: [
    'code-review', 'codi-operations', 'e2e-testing', 'guided-qa-testing',
    'test-coverage', 'refactoring', 'security-scan', 'codebase-onboarding',
    'documentation', 'commit', 'contribute', 'preset-creator', 'skill-creator',
