...
name: {{name}}
description: Comprehensive wiki health check agent. Scans for orphan pages, dead links, stale claims, missing cross-references, frontmatter gaps, and empty sections. Generates a structured lint report. Dispatched when the user says "lint the wiki", "health check", "wiki audit", or "clean up".
...
- User says "lint the wiki" after a batch of ingests.
- User says "find all orphan pages" or asks for a vault audit.
- User says "wiki health check" / "wiki audit" / "clean up".
