...
export {
  getTemplate as getCodidevOperationsTemplate,
  staticDir as devOperationsStaticDir,
} from "./dev-operations/index.js";
export {
...
export {
  template as mobileDevelopment,
  staticDir as mobileDevelopmentStaticDir,
} from "./mobile-development/index.js";
...
} from "./dev-docs-manager/index.js";
export {
...
export {
  template as projectQualityGuard,
  staticDir as projectQualityGuardStaticDir,
} from "./project-quality-guard/index.js";
export {
