...
**Cross-reference**: If the kepano/obsidian-skills plugin is installed, prefer its canonical obsidian-markdown skill for authoritative Obsidian syntax reference. See also [github.com/kepano/obsidian-skills](https://github.com/kepano/obsidian-skills).
...
Standard Markdown tables render natively. No plugin needed.

---

## Mermaid Diagrams

Obsidian renders Mermaid natively. Supported: \`graph\`, \`sequenceDiagram\`, \`gantt\`, \`classDiagram\`, \`pie\`, \`flowchart\`.
