...
**21 generated sections** across 4 doc files:
- **artifacts.md** (9): rule_fields, skill_fields, agent_fields, command_fields, brand_fields, rule_templates, skill_templates, agent_templates, command_templates
