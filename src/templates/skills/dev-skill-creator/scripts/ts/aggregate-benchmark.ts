...
export function aggregateBenchmarks(resultsDir: string): AggregateOutput | null {
...
if (isDirectExecution) {
  ...
  if (!resultsDir) {
    console.error("Usage: npx tsx aggregate-benchmark.ts --results-dir <dir> [--output <file>]");
    process.exit(1);
  }
