...
if (isDirectExecution) {
  ...
  const evalResults: EvalResults = JSON.parse(readFileSync(evalResultsPath, "utf-8"));
  const history: HistoryEntry[] = historyPath ? JSON.parse(readFileSync(historyPath, "utf-8")) : [];
