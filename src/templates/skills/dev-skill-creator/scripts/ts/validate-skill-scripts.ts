...
async function validateSkillScripts(skillDir: string): Promise<ScriptValidationReport> {
...
const isDirectExecution = process.argv[1]?.endsWith("validate-skill-scripts.ts");
