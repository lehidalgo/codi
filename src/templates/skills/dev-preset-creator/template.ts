...
description: |
  ...
  (use ${PROJECT_NAME}-dev-compare-preset), or contributing artifacts back to
  ${PROJECT_NAME_DISPLAY} upstream (use ${PROJECT_NAME}-dev-artifact-contributor).
...
- User wants to compare local vs upstream or audit their preset — use ${PROJECT_NAME}-dev-compare-preset
- User wants to contribute an artifact back to ${PROJECT_NAME_DISPLAY} upstream — use ${PROJECT_NAME}-dev-artifact-contributor
...
- **${PROJECT_NAME}-dev-compare-preset** — Compare two presets or audit the active preset configuration
`;
