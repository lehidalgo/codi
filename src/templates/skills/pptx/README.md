...
| pptxgenjs   | `npm install pptxgenjs` (in your project) | programmatic .pptx creation — install in your own `package.json`; `codi-cli` no longer ships it as a runtime dependency since v2.14.1 |
