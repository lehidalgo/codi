...
/**
 * all.js — Content Factory session-aware export orchestrator
 *
 ...
 *
 * Usage:
 *   node all.js --session /path/to/.codi_output/20260408_1012_content-factory
 *
...
if (!sessionDir) {
  console.error(
    "Usage: node all.js --session <session-dir>\n" +
      "  Example: node all.js --session .codi_output/20260408_1012_content-factory",
  );
  process.exit(1);
}
