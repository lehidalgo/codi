...
**Adapter**
A concrete thing that satisfies an interface at a seam. Describes _role_ (what slot it fills), not substance (what is inside).
...
- **Depth as ratio of implementation-lines to interface-lines** (Ousterhout's framing): rewards padding the implementation. We use depth-as-leverage instead.
