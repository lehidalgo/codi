...
description: |
  ...
  (use ${PROJECT_NAME}-dev-skill-creator), creating a rule (use
  ${PROJECT_NAME}-dev-rule-creator), or bundling multiple artifacts as a preset
  (use ${PROJECT_NAME}-dev-preset-creator).
...
- **${PROJECT_NAME}-dev-skill-creator** — Create a skill that coordinates multiple agents in a workflow
`;
