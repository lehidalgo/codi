#!/usr/bin/env python3
"""
pptx_validator.py — BBVA brand rule checker for PPTX files (Python fallback).
...
def check_brand_mention(text: str) -> tuple[bool, str]:
    ok = "BBVA" in text.upper()
    return ok, "BBVA brand mention found" if ok else "No BBVA mention found"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="BBVA PPTX brand validator")
