...
**[CODING AGENT]** Check if any **Brand** artifact is defined in the project. If a brand exists, use its design tokens (CSS variables, fonts, logos, tone of voice). If no brand exists, use neutral professional defaults.
