...
~/.claude/plugins/cache/codi-marketplace/codi/<version>/skills/dev-sheets-sync/scripts/oauth-user-setup.sh
```
...
```bash
~/.claude/plugins/cache/codi-marketplace/codi/<version>/skills/dev-sheets-sync/scripts/oauth-user-project-client-setup.sh
```
...
~/.claude/plugins/cache/codi-marketplace/codi/<version>/skills/dev-sheets-sync/scripts/gcloud-setup.sh
```
