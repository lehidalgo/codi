...
export function createMockConfig(overrides?: Partial<NormalizedConfig>): NormalizedConfig {
  return {
    ...
    flags: {
      ...
      allow_file_deletion: { value: false, mode: 'enforced', source: 'codi.yaml', locked: false },
      max_file_lines: { value: 500, mode: 'enforced', source: 'codi.yaml', locked: false },
      require_tests: { value: true, mode: 'enforced', source: 'codi.yaml', locked: false },
    },
    mcp: { servers: {} },
    ...overrides,
  };
